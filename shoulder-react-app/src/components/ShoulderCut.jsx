...
/*
 <group {...props} dispose={null}>
      <mesh geometry={nodes.Skin001.geometry} material={materials['Skin TXT']} rotation={[Math.PI / 2, 0, 0]} />
      <mesh geometry={nodes.Superior_Transverse_Scapular_Ligament.geometry} material={materials['Ligmant TXT']} rotation={[Math.PI / 2, 0, 0]} />
      <mesh geometry={nodes.Glenohumeral_Ligament.geometry} material={materials['Ligmant TXT']} rotation={[Math.PI / 2, 0, 0]} />
      <mesh geometry={nodes.Joint_Capsule.geometry} material={materials['Ligmant TXT']} rotation={[Math.PI / 2, 0, 0]} />
      <mesh geometry={nodes.Coracoacromial_Ligament.geometry} material={materials['Ligmant TXT']} rotation={[Math.PI / 2, 0, 0]} />
      <mesh geometry={nodes.Acromioclavicular_Ligament.geometry} material={materials['Ligmant TXT']} rotation={[Math.PI / 2, 0, 0]} />
      <mesh geometry={nodes.Trapezoid_ligament.geometry} material={materials['Ligmant TXT']} rotation={[Math.PI / 2, 0, 0]} />
      <mesh geometry={nodes.Conoid_ligament.geometry} material={materials['Ligmant TXT']} rotation={[Math.PI / 2, 0, 0]} />
      <mesh geometry={nodes.Transverse_humeral_ligament.geometry} material={materials['Ligmant TXT']} rotation={[Math.PI / 2, 0, 0]} />
      <mesh geometry={nodes.Triceps_Brachii.geometry} material={materials['Muscle TXT']} rotation={[Math.PI / 2, 0, 0]} />
      <mesh geometry={nodes.Teres_minor.geometry} material={materials['Muscle TXT']} rotation={[Math.PI / 2, 0, 0]} />
      <mesh geometry={nodes.Teres_major.geometry} material={materials['Muscle TXT']} rotation={[Math.PI / 2, 0, 0]} />
      <mesh geometry={nodes.Supraspinatus.geometry} material={materials['Muscle TXT']} rotation={[Math.PI / 2, 0, 0]} />
      <mesh geometry={nodes.Subscapularis.geometry} material={materials['Muscle TXT']} rotation={[Math.PI / 2, 0, 0]} />
      <mesh geometry={nodes.Infraspinatus.geometry} material={materials['Muscle TXT']} rotation={[Math.PI / 2, 0, 0]} />
      <mesh geometry={nodes.Deltoid.geometry} material={materials['Muscle TXT']} rotation={[Math.PI / 2, 0, 0]} />
      <mesh geometry={nodes.Biceps_Brachii.geometry} material={materials['Muscle TXT']} rotation={[Math.PI / 2, 0, 0]} />
      <mesh geometry={nodes.Scapular_spine.geometry} material={materials['Bone TXT']} rotation={[Math.PI / 2, 0, 0]} />
      <mesh geometry={nodes.Scapula.geometry} material={materials['Bone TXT']} rotation={[Math.PI / 2, 0, 0]} />
      <mesh geometry={nodes.Lesser_tubercle.geometry} material={materials['Bone TXT']} rotation={[Math.PI / 2, 0, 0]} />
      <mesh geometry={nodes.Humerus.geometry} material={materials['Bone TXT']} rotation={[Math.PI / 2, 0, 0]} />
      <mesh geometry={nodes.Head_of_humerus.geometry} material={materials['Bone TXT']} rotation={[Math.PI / 2, 0, 0]} />
      <mesh geometry={nodes.Greater_tubercle.geometry} material={materials['Bone TXT']} rotation={[Math.PI / 2, 0, 0]} />
      <mesh geometry={nodes.Glenoid_fossa.geometry} material={materials['Bone TXT']} rotation={[Math.PI / 2, 0, 0]} />
      <mesh geometry={nodes.Deltoid_tuberosity.geometry} material={materials['Bone TXT']} rotation={[Math.PI / 2, 0, 0]} />
      <mesh geometry={nodes.Coracoid_process.geometry} material={materials['Bone TXT']} rotation={[Math.PI / 2, 0, 0]} />
      <mesh geometry={nodes.Clavicle.geometry} material={materials['Skin TXT']} rotation={[Math.PI / 2, 0, 0]} />
      <mesh geometry={nodes.Acromion.geometry} material={materials['Bone TXT']} rotation={[Math.PI / 2, 0, 0]} />
      <mesh geometry={nodes.Acromioclavicular_joint.geometry} material={materials['Bone TXT']} rotation={[Math.PI / 2, 0, 0]} />
      ...
      <mesh geometry={nodes.Calvicle_Overlay.geometry} material={materials.Plasters} rotation={[Math.PI / 2, 0, 0]} />
      <mesh geometry={nodes.Scapula_Overlay.geometry} material={materials.Plasters} rotation={[Math.PI / 2, 0, 0]} />
      <mesh geometry={nodes.Glenohumeral_joint_overlay.geometry} material={materials.Plasters} rotation={[Math.PI / 2, 0, 0]} />
      <mesh geometry={nodes.Coracoid_process_overlay.geometry} material={materials['Skin TXT']} position={[0, 0, 0.19]} rotation={[Math.PI / 2, 0, 0]} />
    </group>
